...
### 9) Migrar una instalación con submódulos
...
Convierte los módulos ya inicializados como submódulos en clones independientes,
moviendo su directorio Git fuera de `.git/modules`. Los clones independientes se
conservan, y los módulos que nunca fueron inicializados se descargan después con
`./githelper init`.

El comando funciona tanto si el checkout todavía conserva `.gitmodules` y
gitlinks como si el repositorio padre ya está en el layout 4.2.7.
